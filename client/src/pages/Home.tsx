...
export default function Home() {
  ...
  if (loading) return <div className="app-shell loading-shell"><header className="topbar"><div className="brand-lockup"><Mark /><div><div className="brand-title">互盛情報中樞</div><div className="brand-subtitle">INTERNAL BUSINESS INTELLIGENCE <span>/</span> 桃園業務情報</div></div></div><span className="loading-top-note"><span className="loading-pulse" /> 讀取來源索引</span></header><nav className="site-tabs" aria-label="網站主要分頁"><a className="site-tab active" href="#" aria-current="page"><span className="site-tab-index">01</span><span><strong>標案監控</strong><small>即時案件與縣市篩選</small></span></a><a className="site-tab" href="#/specs"><span className="site-tab-index">02</span><span><strong>規格比較</strong><small>七品牌硬規格工作檯</small></span></a></nav><main className="page-container"><SectionSkeleton /></main></div>;
