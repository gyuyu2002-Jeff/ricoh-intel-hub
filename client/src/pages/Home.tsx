...
function SubscribeModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      localStorage.setItem("ricoh_subscriber_info", JSON.stringify(payload));
    } catch {}
    ...
    if (remoteUrl) {
      try {
        ...
        console.warn("Remote subscription sync notice:", err);
      }
    }
      ...
      <div className="subscribe-modal" onClick={(e) => e.stopPropagation()}>
        ...
        {status === "success" ? (
          ...
          <form onSubmit={handleSubmit} className="subscribe-form">
            ...
            {status === "error" && <div className="subscribe-error-msg">{message}</div>}
